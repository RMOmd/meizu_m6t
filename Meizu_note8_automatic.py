...
os.system("adb shell input tap 550 1180") # жмем ок
print("нажали ок")
...
time.sleep(7)
os.system("adb shell input tap 90 190") # назад из apn
print("Выход из точки доступа")
os.system("adb shell input tap 90 190") # выход из карты
print("Выход из сим-карт")
os.system("adb shell input tap 90 190") # выход из сим-карты
print("Выход из карт")
...
os.system('adb shell input text "888"')
time.sleep(1)
os.system("adb shell input tap 540 1900") # звоним
